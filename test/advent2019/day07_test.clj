...
(deftest amplifier-chain-max-phases-test
  (testing "Can find the phase values that maximize the amplifier chain output"
    (is (= [[4,3,2,1,0] 43210] (amplifier-chain-max-phases sample1)))
    (is (= [[0,1,2,3,4] 54321] (amplifier-chain-max-phases sample2)))
    (is (= [[1,0,4,3,2] 65210] (amplifier-chain-max-phases sample3)))))

(deftest day07-part1-soln-test
  (testing "Can reproduce the answer for part1"
    (is (= 567045 (day07-part1-soln)))))
...
(deftest amplifier-loop-max-phases-test
  (testing "Can find the phase values that maximize the amplifier loop output"
    (is (= [[9,8,7,6,5] 139629729] (amplifier-loop-max-phases sample4)))
    (is (= [[9,7,8,5,6] 18216] (amplifier-loop-max-phases sample5)))))

(deftest day07-part2-soln-test
  (testing "Can reproduce the answer for part2"
    (is (= 39016654 (day07-part2-soln)))))
